...
// ---------------------------- IF WANT TO RUN THE CODE THEN COMMENT OUT OTHER AND THEN RUN ONE BY ONE -----------------------
...
public class Array_problem_set {
    ...
    public static void main(String[] args) {
        ...
        float[] arr0 = { 43.3f, 53.5f, 53.53f, 67.00f, 62.f };
        float sum = 0;
        for (float i : arr0) {
            sum += i;
        }
        ...
        // ----------> 2. Write a program to find out whether a given integer is present
        // in an array or not.
        ...
        for (int i = 0; i < arr1.length; i++) { // repeat 2 times or repeat number of rows...
        ...
        int[] ar3 = { 1, 2100, 3, 455, 5, 34, 67 };
        // for finding the max Element pick a min element and which are greater than
        // that
        // will add there...
        ...
        // ----------> 7.Write a Java program to find the maximum element in a Java
        // array.
        ...
        // ------------>8. Write a Java program to find whether an array is sorted or
        // not.

        int[] arr4 = { 1, 12, 3, 4, 5, 34, 67 };
        boolean isSorted = true;
        // Cheke is it in increasing order or not
        for (int i = 0; i < arr4.length - 1; i++) {
            if (arr4[i] > arr4[i + 1]) { // previous one is greater than the next one then its nit a sorted array...
                isSorted = false;
                break;
            }
        }
