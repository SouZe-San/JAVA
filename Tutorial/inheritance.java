...
class child extends Parent {
    ...
    @Override   // -----> This called methods Override .. by this we use methods of parent class with some changes... the changes shown when methode are use by child class
    public void getNumber() {
        System.out.format("this is an Overriding metode \n\tthe number of Child class is %d\n",y);
    }
    child(int b){
        /*
         * Super keyword -->
    ...
    __> the value only use in contractor and also use in constructor......
        ...
        System.out.println("If Number was given by child constructor then upper print called by Child class and  number print given by child");
    }
...
public class inheritance {
    public static void main(String[] args) {
        ...
        p.getNumber();
        child C = new child(6);
        C.setX(8); //------->  this method run As Child class's Method which set Parents class variable
        C.getNumber();
    }
}