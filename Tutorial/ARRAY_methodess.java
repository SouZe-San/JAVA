...
public class ARRAY_methodess {
    ...
    public static void main(String[] args) {
        ...
        // arr1 = new int[20]; // After declaring the variable then allocate the memory for this variable
        
        // int arr3 [] = new int[5];  //----> combine way to declaring and allocate the memory for a variable >>type var-name = new type[size]<<
    ...
    //   System.out.println(Arrays.binarySearch(arr1,4)); // return the index of the element
