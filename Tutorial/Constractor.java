...
class employee { 
    // IF we privet the variables then we can't acess or set input from anywhare...but can set the variable by methose crete in class 
    private String name;
    private int id;

    //If we privet the variables then we have to store value by manually means have to do it from first by constactor ...
    ...
    // --------------> This Constractor OVErload ... here we passes Agruments as we want to set ..... Acesss can be Public or defult
